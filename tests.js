...
describe('remove', function() {
	it('returns an array with the element removed', function() {
		assert.deepEqual([ 'Cadence', 'Ordel' ], remove([ 'Cadence', 'Ordel', 'Marion' ], 'Marion'));
	});

	it('returns the same array if the element is not in the array', function() {
		assert.deepEqual([ 'Cadence', 'Ordel', 'Marion' ], remove([ 'Cadence', 'Ordel', 'Marion' ], 'Riley'));
	});

	it('removes all incidences of the element', function() {
		assert.deepEqual([ 'Cadence', 'Ordel' ], remove([ 'Cadence', 'Marion', 'Ordel', 'Marion' ], 'Marion'));
	});
});
